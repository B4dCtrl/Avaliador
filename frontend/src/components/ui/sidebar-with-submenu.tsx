...
import {
  LayoutDashboard, Search, Calculator, TrendingUp, Database, GraduationCap, LayoutList, Bot,
  Wrench, HelpCircle, Settings, ChevronDown, Pin, PinOff, LogOut, Home,
} from 'lucide-react'
import { Link } from 'react-router-dom'

export type SecaoApp = 'inicio' | 'comparaveis' | 'avaliador' | 'viabilidade' | 'modelos' | 'banco' | 'aprender' | 'assistente'
...
const navigation: MenuItem[] = [
  ...
  { id: 'comparaveis', name: 'Comparáveis', icon: <Search className="w-5 h-5" /> },
  { id: 'avaliador', name: 'Avaliador', icon: <Calculator className="w-5 h-5" /> },
  { id: 'viabilidade', name: 'Viabilidade', icon: <TrendingUp className="w-5 h-5" /> },
